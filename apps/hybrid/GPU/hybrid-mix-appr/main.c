...
int main (int argc, char const *argv[])
{
	...
	time = apprshybrid(row_ptr, col_ind, weights, &approximate_distance, nv, ne, start, iter_num, min_edges, max_edges, percentage, neg_edge_count);
